<?php
if (!class_exists('ChromeNews_Express_Posts_Single_Column')) :
    /**
     * Adds ChromeNews_Express_Posts_Single_Column widget.
     */
    class ChromeNews_Express_Posts_Single_Column extends ChromeNews_Widget_Base
    {
        /**
        ...
        function __construct()
        {
            ...
            $widget_ops = array(
                'classname' => 'chromenews_posts_single_column_widget',
                'description' => __('Displays posts single column from selected categories.', 'chromenews'),
                'customize_selective_refresh' => false,
            );

            parent::__construct('chromenews_posts_single_column', __('AFTA Post Single Column', 'chromenews'), $widget_ops);
        }
                            ...
                            if ($chromenews_all_posts_vertical->have_posts()) :
                                while ($chromenews_all_posts_vertical->have_posts()) : $chromenews_all_posts_vertical->the_post();
                                    ...
                                    <div class="list-style">
                                        <?php do_action('chromenews_action_loop_list', $post->ID, 'medium', 0, true, true, true, true); ?>
                                    </div>
                                <?php
                                endwhile;
                            endif;
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::chromenews_generate_text_input('chromenews-posts-list-title', __('Title', 'chromenews'), 'Post Single Column');
